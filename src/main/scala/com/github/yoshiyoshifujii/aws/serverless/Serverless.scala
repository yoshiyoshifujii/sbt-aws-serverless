  ...
  def deployCopyTask(key: InputKey[Unit]): Initialize[InputTask[Unit]] =
    Def.inputTask {
      (for {
        ...
        sys.error(
          "Error deployCopy. useage: deployCopy <from stage> <to stage>")
      }
    }
  ...
  def deployFunctionTask(key: InputKey[Unit]): Initialize[InputTask[Unit]] =
    Def.inputTask {
      (for {
        ...
        sys.error(
          "Error deployFunction. useage: deployFunction <functionName>")
      }
    }
  ...
  def removeDeploymentTask(key: InputKey[Unit]): Initialize[InputTask[Unit]] =
    Def.inputTask {
      (for {
        ...
        sys.error(
          "Error removeDeployment. useage: removeDeployment <deploymentId>")
      }
    }
